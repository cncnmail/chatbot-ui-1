...
AS $$
DECLARE
  project_url TEXT := 'https://kebzgqxbyodjajaizcqw.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtlYnpncXhieW9kamFqYWl6Y3F3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjQ4NjY4MiwiZXhwIjoyMDIyMDYyNjgyfQ.Ml9OIgUxQQqL7rzfp__A_3uk9sY6kX_wT930pIwsX9Y'; -- full access needed for http request to storage
